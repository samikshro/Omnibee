...
import 'package:Omnibee/bloc/simple_bloc_observer.dart';
import 'package:Omnibee/repository/repositories.dart';
import 'package:flutter/services.dart';
import 'package:Omnibee/auth/root_page.dart';
import 'package:Omnibee/pages/explore/big_explore/bigAcceptOrder.dart';

import 'package:Omnibee/pages/explore/explore_card/deliveryCardPage.dart';
import 'package:Omnibee/pages/explore/explore_card/orderCardPage.dart';
import 'package:Omnibee/pages/explore/matching_progress/matchingProgress.dart';
import 'package:Omnibee/pages/map/expandedMap.dart';
import 'package:flutter/material.dart';

import 'package:Omnibee/pages/explore/explore.dart';
import 'package:Omnibee/pages/chat/chatList.dart';
import 'package:Omnibee/pages/explore/delivery.dart';
import 'package:Omnibee/pages/chat/chat.dart';
import 'package:Omnibee/pages/explore/menu/menu.dart';
import 'package:Omnibee/pages/explore/menu/menuOrderForm.dart';
import 'package:Omnibee/pages/explore/menu/basketForm.dart';
import 'package:Omnibee/pages/explore/request/request.dart';

import 'package:Omnibee/pages/explore/big_explore/bigMode.dart';
import 'package:Omnibee/pages/explore/big_explore/bigFilter.dart';
...
class Omnibee extends StatelessWidget {
  @override
